...
exports.timeExpire = exports.timeExpired = exports.isObjectEmpty = exports.generateid = exports.randomid = exports.secondTillZero = void 0;
...
const timeExpire = (future, milli = 0) => {
    const time = (new Date(future).getTime() + (milli * 60 * 1000)) - Date.now();
    return time;
};
exports.timeExpire = timeExpire;
